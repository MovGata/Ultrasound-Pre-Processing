...
namespace gui
{
    ...
    public:
        ...
        std::variant<std::shared_ptr<Kernel<opencl::ToPolar, opencl::ToPolar, ultrasound::Mindray>>, std::shared_ptr<Kernel<ultrasound::Mindray, opencl::ToPolar, ultrasound::Mindray>>> kernel;
