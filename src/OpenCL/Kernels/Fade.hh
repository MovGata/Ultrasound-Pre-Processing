#ifndef OPENCL_KERNELS_FADE_HH
#define OPENCL_KERNELS_FADE_HH
...
namespace opencl
{
    ...
    public:
        ...
        Fade(const cl::Context &c, const cl::CommandQueue &q, const std::shared_ptr<opencl::Kernel> &ptr) : kernel(ptr), context(c), queue(q)
        {
        }
