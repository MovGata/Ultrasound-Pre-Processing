#ifndef OPENCL_KERNELS_SQRT_HH
#define OPENCL_KERNELS_SQRT_HH
...
namespace opencl
{
    ...
    public:
        ...
        Sqrt(const cl::Context &c, const cl::CommandQueue &q, const std::shared_ptr<opencl::Kernel> &ptr) : kernel(ptr), context(c), queue(q)
        {
        }
