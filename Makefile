...
# G++ Flags
GPP = -std=c++2a -O0 -g -fconcepts -Werror -Wextra -Wall -Wfloat-equal -Wundef -Wshadow -Wpointer-arith -Wcast-align -Wwrite-strings -Wcast-qual -Wswitch-enum -Wconversion -Wno-unknown-pragmas -fconcepts-diagnostics-depth=2#-Wfatal-errors #-DDEBUG_Matrix #-DDEBUG_VECTOR3
# Linker flags
