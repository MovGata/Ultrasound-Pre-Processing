...
# G++ Flags
GPP = -std=c++2a -s -O3 -fconcepts -Werror -Wextra -Wall -Wfloat-equal -Wundef -Wshadow -Wpointer-arith -Wcast-align -Wwrite-strings -Wcast-qual -Wswitch-enum -Wconversion -Wno-unknown-pragmas -fconcepts-diagnostics-depth=2 -Wa,-mbig-obj#-Wfatal-errors #-DDEBUG_Matrix #-DDEBUG_VECTOR3
# Linker flags
